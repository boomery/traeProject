...
- (void)viewDidLoad {
    ...
    // 加载视频资源嗅探脚本
    NSString *scriptPath = [[NSBundle mainBundle] pathForResource:@"video-detection" ofType:@"js"];
    NSString *videoDetectionScript = [NSString stringWithContentsOfFile:scriptPath encoding:NSUTF8StringEncoding error:nil];
